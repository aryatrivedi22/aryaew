...
const CTASection = () => {
  return (
    <section className="w-full flex justify-center pb-24 pt-8 px-2 bg-gray-100">
      <motion.a
        ...
        viewport={{ once: true }}
        href="/products"
        className="2xl:mx-32 flex bg-linear-to-tr from-[#708c98] via-[#708c98]/80 to-[#708c98]/50 py-6 px-4 shadow transition-all duration-300 hover:shadow-2xl rounded-xl group"
      >
